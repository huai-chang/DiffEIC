...
class DDPM(pl.LightningModule, ImageLoggerMixin):
    ...
    def q_sample_bias(self, x_start, t, sigma=0, noise=None):
        ...
        sqrt_one_minus_alphas_cumprod = extract_into_tensor(self.sqrt_one_minus_alphas_cumprod, t, x_start.shape)
        alphas_cumprod = sqrt_alphas_cumprod ** 2
        one_minus_alphas_cumprod = sqrt_one_minus_alphas_cumprod ** 2
        sqrt_one_minus_alphas_cumprod_minus_sigma = torch.sqrt(one_minus_alphas_cumprod - sigma * alphas_cumprod)
        return (sqrt_alphas_cumprod * x_start + sqrt_one_minus_alphas_cumprod_minus_sigma * noise)
